...
# Topic 2：Punishment Length Across Age Groups
...
This section focuses on whether punishment length changes with age.
Using the PunishmentsQ12023 dataset, we investigate how the average number of days assigned as punishment differs across age groups.
By summarising and visualising these patterns, we aim to identify whether certain age ranges tend to receive longer or shorter punishments, and what this may suggest about behavioural or disciplinary differences among age groups.
...
# Logistic Regression Coefficients (Part 1)
...
coef_tbl_1 %>%
  ...
  gt() %>%
  tab_header(
    title = md("**Logistic Regression Results – Part 1**")
  ) %>%
  cols_label(
    term      = "Predictor",
    estimate  = "Est.",
...
# Logistic Regression Coefficients (Part 2)
...
coef_tbl_2 %>%
  ...
  gt() %>%
  tab_header(
    title = md("**Logistic Regression Results – Part 2**")
  ) %>%
  cols_label(
    term      = "Predictor",
    estimate  = "Est.",
