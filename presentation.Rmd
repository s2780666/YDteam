...
Our visualisations suggested that there is a tendancy for offenders in certain age groups to commit certain crimes more than other age groups. The low AUC value for our ROC curve suggests there is little or no link between age and severity of offences, this appears to be due to the fact that offences we can reasonably label as 'severe' are too broad and to get more insight we may have to look at a more specific kind of offence.
